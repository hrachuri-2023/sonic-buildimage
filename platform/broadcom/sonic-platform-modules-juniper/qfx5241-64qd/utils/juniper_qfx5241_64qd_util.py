...
'modprobe i2c-mux',
'modprobe mfd-core',
'modprobe qfx5241-64qd-jnx-garnet-core',
'modprobe qfx5241-64qd-i2c-ocores-garnet',
'modprobe qfx5241-64qd-gpio-garnet',
'modprobe qfx5241-64qd-jnx-xrefpga-lpcm',
]
...
def main():
    ...
    EEPROMDataCmd = ['python', '/usr/share/sonic/device/x86_64-juniper_qfx5241-64qd-r0/plugins/qfx5241_64qd_eeprom_data.py']
    try:
