...
'modprobe i2c-mux',
'modprobe mfd-core',
'modprobe qfx5240-64od-jnx-garnet-core',
'modprobe qfx5240-64od-i2c-ocores-garnet',
'modprobe qfx5240-64od-gpio-garnet',
]
...
def main():
    ...
    CreateEEPROMdeviceCmd = '24c02 0x50'
    ...
    EEPROMDataCmd = ['python', '/usr/share/sonic/device/x86_64-juniper_qfx5240-64od-r0/plugins/qfx5240_od_eeprom_data.py']
    try:
